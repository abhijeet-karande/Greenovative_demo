...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReadAll = channel.unary_unary(
                '/user.UserService/ReadAll',
                request_serializer=user__pb2.ReadAllRequest.SerializeToString,
                response_deserializer=user__pb2.ReadAllResponse.FromString,
                )
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ReadAll': grpc.unary_unary_rpc_method_handler(
                    servicer.ReadAll,
                    request_deserializer=user__pb2.ReadAllRequest.FromString,
                    response_serializer=user__pb2.ReadAllResponse.SerializeToString,
            ),
    }
...
class UserService(object):
    ...
    def ReadAll(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/user.UserService/ReadAll',
            user__pb2.ReadAllRequest.SerializeToString,
            user__pb2.ReadAllResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
